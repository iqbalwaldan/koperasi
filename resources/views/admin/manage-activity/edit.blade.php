                        ...
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <form class="form form-vertical"
                                    action="{{ route('admin.manage-activity.update', $data[0]['slug']) }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <figure class="text-center overflow-hidden">
                                                    <img src="{{ $data[0]['image_url'] }}" alt="" width="800"
                                            ...
                                            <div class="my-3">
                                                @foreach ($data[0]['attachment'] as $attachment)
                                                    <a href="{{ $attachment['url'] }}"
                                                        class="btn-success rounded px-3 py-2">{{ $attachment['name'] }}</a>
                                                @endforeach
                                            </div>
