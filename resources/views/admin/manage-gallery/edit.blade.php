...
@section('main')
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <form class="form form-vertical"
                                    action="{{ route('admin.manage-gallery.update', $data[0]['slug']) }}"
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="title" class="form-control" name="title"
                                                        placeholder="Judul" value="{{ old('title', $data[0]['title']) }}">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" id="date_news" class="form-control"
                                                        ...
                                                        value="{{ old('date_news', $data[0]['date_news']) }}">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                            ...
                                            <div class="row g-3">
                                                @foreach ($data[0]['images'] as $image)
                                                    <div class="col-md-4 col-sm-6">
                                                        <figure class="overflow-hidden rounded-3" style="height: 250px">
                                                            <img src="{{ $image['url'] }}" alt="" class="img-fluid img-cover border">
                                                        </figure>
                                                    </div>
                                                @endforeach
                                            </div>
    ...
    <script>
        ...
        const description = @json($data[0]['description']);
