                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <form class="form form-vertical" action="{{ route('admin.manage-video.store') }}"
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="video-title" class="form-control" name="video_title"
                                                        placeholder="Masukkan judul video..." value="{{ old('video_title') }}" required>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="video-url" class="form-control" name="video_url"
                                                        placeholder="Masukkan link video..." value="{{ old('video_url') }}" required>
                                                </div>
                                            </div>
