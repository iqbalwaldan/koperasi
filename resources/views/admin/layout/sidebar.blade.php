        ...
        <div>
            <div class="sidebar-header">
                <div class="d-flex justify-content-between">
                    <div class="logo">
                        <a href="index.html"><img src="{{ asset('assets/img/Logo DISKOPUKMPERINDAG Kab. Sumenep.png') }}"
                                alt="Logo" srcset="" style="width: 250px; height: auto;"></a>
                    </div>
                    <div class="toggler">
                ...
                <ul class="menu">
                    @if (auth()->user()->getRoleNames()[0] == 'super-admin')
                        ...
                        <li class="sidebar-item {{ $active == 'struktur-keanggotaan' ? 'active' : '' }}">
                            <a href="{{ route('admin.manage-member-structure.index') }}" class='sidebar-link'>
                                <i class="bi bi-grid-fill"></i>
                        ...
                        <li class="sidebar-item {{ $active == 'regulasi' ? 'active' : '' }}" has-sub>
                            <a href="{{ route('admin.manage-data.index', ['slug' => 'regulasi']) }}"
                                class="sidebar-link">
                                <i class="bi bi-grid-fill"></i>
                                <span>Regulasi</span>
                            </a>
                        ...
                        <li class="sidebar-item {{ $active == 'informasi' ? 'active' : '' }}" has-sub>
                            <a href="{{ route('admin.manage-data.index', ['slug' => 'informasi']) }}"
                                class="sidebar-link">
                                <i class="bi bi-grid-fill"></i>
                                <span>Informasi</span>
                            </a>
