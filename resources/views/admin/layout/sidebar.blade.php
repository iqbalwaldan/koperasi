    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header">
            <div class="d-flex justify-content-between">
                <div class="logo">
                    <a href="index.html"><img src="{{ asset('assets/img/dinkop.png') }}" alt="Logo" srcset="" style="width: 200px; height: auto;"></a>
                </div>
                <div class="toggler">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item {{ $active == 'gallery' ? 'active' : '' }}"">
                    <a href="/admin/galeri" class='sidebar-link'>
                        <i class="bi bi-grid-fill"></i>
                        <span>Galeri</span>
                    </a>
                </li>
